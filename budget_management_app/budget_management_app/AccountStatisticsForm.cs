...
{
    public partial class AccountStatisticsForm : Form
    {
        DBConnection dbcon=new DBConnection();
        static string newCurrCode;
        static int newAccCurrId;
        static int accId;
        public AccountStatisticsForm()
        {
            InitializeComponent();
            getCurr();
            getData();
            textBox_name.Text = AccountsForm.selectedAccountName;
        }

        private void getData()
        {
            string selectQuery = "SELECT AccId,AccCurrId, AccBalance,AccName FROM Account WHERE AccName = '"+ AccountsForm.selectedAccountName + "'";
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string deleteAccountQuery = "DELETE FROM Account WHERE AccName = '" + AccountsForm.selectedAccountName + "' AND UserId= " + LoginForm.userId;
